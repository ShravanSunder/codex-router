...
#[derive(Parser)]
#[command(
    name = "agent-collaboration delivery",
    bin_name = "agent-collaboration delivery"
)]
...
#[derive(Parser)]
#[command(
    name = "agent-collaboration revision",
    bin_name = "agent-collaboration revision"
)]
...
#[derive(Parser)]
#[command(
    name = "agent-collaboration operation",
    bin_name = "agent-collaboration operation"
)]
