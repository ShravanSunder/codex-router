...
#[derive(Parser)]
#[command(
    name = "agent-collaboration schedule",
    bin_name = "agent-collaboration schedule"
)]
...
enum PreparedSchedule {
    ...
    Import(collaboration_client::protocol::ScheduleImportRequest),
    Prepare {
        operation_id: OperationId,
        schedule_id: collaboration_client::protocol::ScheduleId,
...
enum ScheduleOutput {
    ...
    Package(collaboration_client::protocol::ScheduleExportResult),
}
    ...
    let result: Result<ScheduleOutput, ScheduleClientError> = runtime.block_on(async {
        ...
        let result = match prepared {
            ...
            PreparedSchedule::Prepare {
                ...
                .prepare_schedule(collaboration_client::protocol::SchedulePrepareRequest {
                    operation_id,
                    schedule_id,
...
fn prepare(command: ScheduleAction) -> Result<PreparedSchedule, String> {
    match command {
        ...
        ScheduleAction::Import {
            ...
            collaboration_client::protocol::ScheduleImportRequest {
