...
use super::credentials::PreparedCredentialAuthorityRead;
use super::credentials::prepare_reset_credential_authority_read;
...
fn render_safe_credential_failure(
    error: super::credentials::CredentialAuthorityError,
) -> RenderSafeFailure {
    match error {
