...
use super::reset_commit_service::ConfirmationAuthority;
use super::reset_commit_service::InspectionAuthority;
use super::reset_commit_service::ResetAuthorityReader;
use super::reset_commit_service::ResetServiceProvider;
use super::reset_commit_service::ResetWorkflowService;
use super::reset_commit_service::RevalidationContext;
use super::reset_commit_service::StartedAuthorityRead;
use super::reset_credit_policy::ActiveCredentialGeneration;
use super::reset_credit_policy::ConsumePortResult;
use super::reset_credit_policy::ConsumeUnknownReason;
...
use super::reset_workflow_reducer::CorrelatedOutcome;
use super::reset_workflow_reducer::InspectionStart;
use super::reset_workflow_reducer::OperationCorrelation;
use super::reset_workflow_reducer::ResetWorkflow;
use super::reset_workflow_reducer::WorkflowIntent;

mod live_reset_inspection;
mod reset_commit_revalidation;
mod reset_effect_execution;
mod reset_presentation_protocol;
mod reset_session_state;

#[cfg(test)]
pub(crate) use super::reset_credit_policy::ConsumeUnknownReason as TestConsumeUnknownReason;
pub(crate) use super::reset_credit_policy::KnownConsumeOutcome;
#[cfg(test)]
pub(crate) use super::reset_credit_policy::RenderSafeFailure as TestRenderSafeFailure;
pub(crate) use super::reset_workflow_reducer::ConfirmationSelection;
pub(crate) use super::reset_workflow_reducer::OperationActivity;
pub(crate) use super::reset_workflow_reducer::OperationSuccess;
pub(crate) use super::reset_workflow_reducer::WorkflowPhase;
pub(crate) use super::reset_workflow_reducer::WorkflowResult;
use reset_effect_execution::GenerationAllocator;
pub(in crate::quota_reset) use reset_effect_execution::ProductionRedeemRequestIdFactory;
pub(in crate::quota_reset) use reset_effect_execution::ProductionResetClock;
...
pub(crate) use reset_presentation_protocol::PinnedTargetInvalidationReason;
#[cfg(test)]
pub(crate) use reset_presentation_protocol::ResetCreditDisplayRecord;
pub(crate) use reset_presentation_protocol::ResetCreditDisplayStatusDto;
pub(crate) use reset_presentation_protocol::ResetEligibilityDisabledReason;
pub(crate) use reset_presentation_protocol::ResetIntentSender;
pub(crate) use reset_presentation_protocol::ResetSessionIntent;
pub(crate) use reset_presentation_protocol::ResetSessionOutcome;
pub(crate) use reset_presentation_protocol::ResetSessionPorts;
pub(crate) use reset_presentation_protocol::ResetValueProvenance;
pub(crate) use reset_presentation_protocol::ResetWorkflowSnapshot;
...
struct PendingInspectionAuthorityRead<TAuthority: super::reset_commit_service::ResetAuthority> {
    start: InspectionStart,
    now_unix_seconds: u64,
    operation: StartedAuthorityRead<TAuthority>,
}

struct PendingRevalidationAuthorityRead<TAuthority: super::reset_commit_service::ResetAuthority> {
