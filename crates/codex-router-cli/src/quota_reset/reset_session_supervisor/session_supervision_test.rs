...
use super::*;
use crate::quota_reset::provider_protocol::LiveResetAccountAuth;
use crate::quota_reset::reset_commit_service::ResetAuthority;
...
use crate::quota_reset::reset_credit_policy::RedeemRequestId;
use crate::quota_reset::reset_credit_policy::SelectedResetCreditSnapshot;
...
impl ResetAuthorityReader for HeldAuthorityReader {
    ...
    ) -> crate::quota_reset::reset_commit_service::StartedAuthorityRead<Self::Authority> {
        Box::pin(async move {
