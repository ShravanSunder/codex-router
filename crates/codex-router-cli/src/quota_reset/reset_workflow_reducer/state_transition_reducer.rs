...
use super::reset_workflow_state::AuthorityObservation;
use super::reset_workflow_state::ConfirmationSelection;
use super::reset_workflow_state::InspectionStart;
use super::reset_workflow_state::OperationSuccess;
use super::reset_workflow_state::ResetWorkflow;
use super::reset_workflow_state::WorkflowActivities;
use super::reset_workflow_state::WorkflowIntent;
use super::reset_workflow_state::WorkflowResult;
...
impl ResetWorkflow {
    ...
    pub(in crate::quota_reset) fn inventory_observation(
        ...
        &crate::quota_reset::reset_credit_policy::ValidatedCreditInventory,
                    ...
                    ConsumePortResult::OutcomeUnknown(reason) => {
                        self.activities.consume_credit = OperationActivity::Failed {
                            failure: match reason {
                                crate::quota_reset::reset_credit_policy::ConsumeUnknownReason::Transport => {
                                    RenderSafeFailure::Transport
                                }
                                crate::quota_reset::reset_credit_policy::ConsumeUnknownReason::TimedOut => {
                                    RenderSafeFailure::TimedOut
                                }
                                crate::quota_reset::reset_credit_policy::ConsumeUnknownReason::ProviderStatus => {
                                    RenderSafeFailure::ProviderStatus
                                }
                                crate::quota_reset::reset_credit_policy::ConsumeUnknownReason::InvalidResponse => {
