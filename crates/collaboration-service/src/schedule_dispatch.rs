...
pub(crate) struct FailureContext {
    pub operation_id: Option<collaboration_protocol::OperationId>,
    pub schedule_id: Option<collaboration_protocol::ScheduleId>,
}
...
pub(crate) fn failure(
    ...
    current_change_id: Option<collaboration_protocol::ChangeId>,
) -> Value {
