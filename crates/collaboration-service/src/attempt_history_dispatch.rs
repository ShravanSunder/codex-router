...
pub(crate) async fn dispatch(request: AttemptRequest<'_>) -> Value {
    ...
    let page = match history {
        ...
        Ok(AttemptHistoryRead::Expired) => {
            ...
            error.kind = collaboration_protocol::AutomationInspectionFailureKind::HistoryExpired;
            error.stage = collaboration_protocol::AutomationInspectionStage::Inspection;
            error.next_action =
                collaboration_protocol::AutomationInspectionNextAction::RefreshCurrentState;
