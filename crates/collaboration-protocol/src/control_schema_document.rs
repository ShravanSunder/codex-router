...
pub fn control_schema_document(
    ...
    assembly.add_type::<message_board::BoardError>("board-failure")?;
    assembly
        .add_method::<message_board::ProjectCreateRequest, message_board::ProjectCreateResult>(
            "board/projectCreate",
            &[],
        )?;
    assembly
        .add_method::<message_board::ProjectUpdateRequest, message_board::ProjectUpdateResult>(
            "board/projectUpdate",
            &[],
        )?;
    assembly.add_method::<message_board::ProjectShowRequest, message_board::ProjectShowResult>(
        "board/projectShow",
        &[],
    )?;
    assembly.add_method::<message_board::ProjectListRequest, message_board::ProjectListResult>(
        "board/projectList",
        &[],
    )?;
    assembly.add_method::<message_board::RepositoryAttachRequest, message_board::RepositoryAttachResult>("board/repositoryAttach", &[])?;
    assembly.add_method::<message_board::RepositoryDetachRequest, message_board::RepositoryDetachResult>("board/repositoryDetach", &[])?;
    assembly
        .add_method::<message_board::RepositoryListRequest, message_board::RepositoryListResult>(
            "board/repositoryList",
            &[],
        )?;
    assembly.add_method::<message_board::BoardCreateRequest, message_board::BoardCreateResult>(
        "board/create",
        &[],
    )?;
    assembly.add_method::<message_board::BoardUpdateRequest, message_board::BoardUpdateResult>(
        "board/update",
        &[],
    )?;
    assembly.add_method::<message_board::BoardShowRequest, message_board::BoardShowResult>(
        "board/show",
        &[],
    )?;
    assembly.add_method::<message_board::BoardListRequest, message_board::BoardListResult>(
        "board/list",
        &[],
    )?;
    assembly.add_method::<message_board::BoardArchiveRequest, message_board::BoardArchiveResult>(
        "board/archive",
        &[],
    )?;
    assembly.add_method::<message_board::TopicCreateRequest, message_board::TopicCreateResult>(
        "board/topicCreate",
        &[],
    )?;
    assembly.add_method::<message_board::TopicUpdateRequest, message_board::TopicUpdateResult>(
        "board/topicUpdate",
        &[],
    )?;
    assembly.add_method::<message_board::TopicListRequest, message_board::TopicListResult>(
        "board/topicList",
        &[],
    )?;
    assembly
    ...
    assembly.add_method::<message_board::MessageShowRequest, message_board::MessageShowResult>(
        "board/messageShow",
        &[],
    )?;
    assembly.add_method::<message_board::MessageListRequest, message_board::MessageListResult>(
        "board/messageList",
        &[],
    )?;
    assembly.add_method::<message_board::ThreadShowRequest, message_board::ThreadShowResult>(
        "board/threadShow",
        &[],
    )?;
    assembly
        .add_method::<message_board::ThreadResolveRequest, message_board::ThreadResolveResult>(
            "board/threadResolve",
            &[],
        )?;
    assembly
        .add_method::<message_board::ThreadUnresolveRequest, message_board::ThreadUnresolveResult>(
            "board/threadUnresolve",
            &[],
        )?;
    assembly.add_method::<message_board::ThreadWatchRequest, message_board::ThreadWatchResult>(
        "board/threadWatch",
        &[],
    )?;
    assembly
        .add_method::<message_board::ThreadUnwatchRequest, message_board::ThreadUnwatchResult>(
            "board/threadUnwatch",
            &[],
        )?;
    ...
    assembly.add_method::<message_board::InboxAcknowledgeRequest, message_board::InboxAcknowledgeResult>("board/inboxAcknowledge", &[])?;
    assembly
        .add_method::<message_board::InboxProjectsRequest, message_board::InboxProjectsResult>(
            "board/inboxProjects",
            &[],
        )?;
